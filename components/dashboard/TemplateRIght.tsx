...
function TemplateRIght() {
  return (
    <div className=' mt-4'>
      <div className='text-section px-3 space-y-2'>
        <div className='container-text p-3 rounded-md border text-sm shadow-sm '>
          <h1 className='text-xl font-semibold pb-2'>Instruction</h1>
